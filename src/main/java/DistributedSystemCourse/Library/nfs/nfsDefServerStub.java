...
/**
 */
public abstract class nfsDefServerStub extends OncRpcServerStub implements OncRpcDispatchable {

    public nfsDefServerStub()
           throws OncRpcException, IOException {
        this(0);
    }

    public nfsDefServerStub(int port)
           throws OncRpcException, IOException {
        this(null, port);
    }

    public nfsDefServerStub(InetAddress bindAddr, int port)
           throws OncRpcException, IOException {
        info = new OncRpcServerTransportRegistrationInfo [] {
            new OncRpcServerTransportRegistrationInfo(nfsDef.NFS_PROGRAM, 2),
        };
