...
/**
 */
public abstract class mountDefServerStub extends OncRpcServerStub implements OncRpcDispatchable {

    public mountDefServerStub()
           throws OncRpcException, IOException {
        this(0);
    }

    public mountDefServerStub(int port)
           throws OncRpcException, IOException {
        this(null, port);
    }

    public mountDefServerStub(InetAddress bindAddr, int port)
           throws OncRpcException, IOException {
        info = new OncRpcServerTransportRegistrationInfo [] {
            new OncRpcServerTransportRegistrationInfo(mountDef.MOUNTPROG, 1),
        };
...
// End of mountDefServerStub.java
