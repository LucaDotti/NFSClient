...
/**
 * The class <code>mountDefClient</code> implements the client stub proxy
 * for the MOUNTPROG remote program. It provides method stubs
 * which, when called, in turn call the appropriate remote method (procedure).
 */
public class mountDefClient extends OncRpcClientStub {

    /**
     * Constructs a <code>mountDefClient</code> client stub proxy dummy.
     * @throws OncRpcException if an ONC/RPC error occurs.
     * @throws IOException if an I/O error occurs.
     */
    public mountDefClient() throws OncRpcException, IOException {
        super(null);
    }

    /**
     * Constructs a <code>mountDefClient</code> client stub proxy object
     ...
     * @throws IOException if an I/O error occurs.
     */
    public mountDefClient(InetAddress host, int protocol)
           throws OncRpcException, IOException {
        super(host, mountDef.MOUNTPROG, 1, 0, protocol);
    }
     ...
     * @throws IOException if an I/O error occurs.
     */
    public mountDefClient(InetAddress host, int port, int protocol)
           throws OncRpcException, IOException {
        super(host, mountDef.MOUNTPROG, 1, port, protocol);
    }
     ...
     * @throws IOException if an I/O error occurs.
     */
    public mountDefClient(OncRpcClient client)
           throws OncRpcException, IOException {
        super(client);
    }
     ...
     * @throws IOException if an I/O error occurs.
     */
    public mountDefClient(InetAddress host, int program, int version, int protocol)
           throws OncRpcException, IOException {
     ...
     * @throws IOException if an I/O error occurs.
     */
    public mountDefClient(InetAddress host, int program, int version, int port, int protocol)
           throws OncRpcException, IOException {
    ...
    public void MOUNTPROC_NULL_1()
        ...
        client.call(mountDef.MOUNTPROC_NULL_1, mountDef.MOUNTVERS, args$, result$);
    }
    ...
    public fhstatus MOUNTPROC_MNT_1(dirpath arg1)
        ...
        client.call(mountDef.MOUNTPROC_MNT_1, mountDef.MOUNTVERS, arg1, result$);
        return result$;
    }
    ...
    public mountlist MOUNTPROC_DUMP_1()
        ...
        client.call(mountDef.MOUNTPROC_DUMP_1, mountDef.MOUNTVERS, args$, result$);
        return result$;
    }
    ...
    public void MOUNTPROC_UMNT_1(dirpath arg1)
           throws OncRpcException, IOException {
        XdrVoid result$ = XdrVoid.XDR_VOID;
        client.call(mountDef.MOUNTPROC_UMNT_1, mountDef.MOUNTVERS, arg1, result$);
    }
    ...
    public void MOUNTPROC_UMNTALL_1()
        ...
        XdrVoid args$ = XdrVoid.XDR_VOID;
        XdrVoid result$ = XdrVoid.XDR_VOID;
        client.call(mountDef.MOUNTPROC_UMNTALL_1, mountDef.MOUNTVERS, args$, result$);
    }
    ...
    public exportlist MOUNTPROC_EXPORT_1()
        ...
        client.call(mountDef.MOUNTPROC_EXPORT_1, mountDef.MOUNTVERS, args$, result$);
        return result$;
    }

}
// End of mountDefClient.java
